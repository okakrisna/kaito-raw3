(function() {
    ...
    1: [function(require, module, exports) {
        window.expressionLanguage = require("expression-language")
    }, {
        ...
        class ArrayAdapter {
            constructor(defaultLifetime = 0) {
                ...
                _defineProperty(this, "getItems", keys => {
                    ...
                    return this.generateItems(keys, (new Date).getTime() / 1e3, this.createCacheItem)
                });
                ...
                _defineProperty(this, "save", item => {
                    ...
                    if (item.expiry !== null && item.expiry <= (new Date).getTime() / 1e3) {
                        this.deleteItem(item.key);
                        return true
                    }
                    if (null === item.expiry && 0 < item.defaultLifetime) {
                        item.expiry = (new Date).getTime() / 1e3 + item.defaultLifetime
                    }
                ...
                _defineProperty(this, "hasItem", key => {
                    if (typeof key === "string" && this.expiries[key] && this.expiries[key] > (new Date).getTime() / 1e3) {
                        return true
                    }
                    CacheItem.validateKey(key);
        ...
        class CacheItem {
            constructor() {
                ...
                _defineProperty(this, "expiresAt", expiration => {
                    if (null === expiration) {
                        this.expiry = this.defaultLifetime > 0 ? Date.now() / 1e3 + this.defaultLifetime : null
                    } else if (expiration instanceof Date) {
                        this.expiry = expiration.getTime() / 1e3
                    } else {
                ...
                _defineProperty(this, "expiresAfter", time => {
                    if (null === time) {
                        ...
                        this.expiry = (new Date).getTime() / 1e3 + time
                    } else {
    ...
    7: [function(require, module, exports) {
                ...
                if (number !== null) {
                    ...
                    if ("([{".indexOf(expression[cursor]) >= 0) {
                        ...
                        if (")]}".indexOf(expression[cursor]) >= 0) {
                            ...
                            let [expect, cur] = brackets.pop(), matchExpect = expect.replace("(", ")").replace("{", "}").replace("[", "]");
        ...
        const operators = ["&&", "and", "||", "or", "+", "-", "*", "/", "%", "**", "&", "|", "^", "===", "!==", "!=", "==", "<=", ">=", "<", ">", "matches", "not in", "in", "not", "!", "~", ".."];
    ...
    20: [function(require, module, exports) {
                ...
                _defineProperty(this, "parsePostfixExpression", node => {
                    ...
                    while (_TokenStream.Token.PUNCTUATION_TYPE === token.type) {
                        if ("." === token.value) {
                            ...
                            token = this.tokenStream.current;
                            this.tokenStream.next();
                            if (_TokenStream.Token.NAME_TYPE !== token.type && (_TokenStream.Token.OPERATOR_TYPE !== token.type || !/[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/.test(token.value))) {
        ...
        "./Node/ArgumentsNode": 9,
        "./Node/ArrayNode": 10,
        "./Node/BinaryNode": 11,
        "./Node/ConditionalNode": 12,
        "./Node/ConstantNode": 13,
        "./Node/FunctionNode": 14,
        "./Node/GetAttrNode": 15,
        "./Node/NameNode": 16,
        "./Node/Node": 17,
        "./Node/UnaryNode": 18,
    ...
    22: [function(require, module, exports) {
        ...
        "./AbstractProvider": 21,
        "locutus/php/array/array_intersect": 34,
        "locutus/php/array/count": 35,
        "locutus/php/strings/implode": 40
    }],
    ...
    24: [function(require, module, exports) {
        ...
        "../ExpressionFunction": 5,
        "./AbstractProvider": 21,
        "locutus/php/datetime/date": 36,
        "locutus/php/datetime/strtotime": 37
    }],
    25: [function(require, module, exports) {
        ...
        "../ExpressionFunction": 5,
        "./AbstractProvider": 21,
        "locutus/php/strings/explode": 39,
        "locutus/php/strings/stristr": 41,
        "locutus/php/strings/strlen": 42,
        "locutus/php/strings/strstr": 43,
        "locutus/php/strings/strtolower": 44,
        "locutus/php/strings/strtoupper": 45,
        "locutus/php/strings/substr": 46
    }],
    ...
    28: [function(require, module, exports) {
        ...
        "./Compiler": 3,
        "./ExpressionFunction": 5,
        "./ExpressionLanguage": 6,
        "./Lexer": 7,
        "./Parser": 20,
        "./Provider/ArrayProvider": 22,
        "./Provider/BasicProvider": 23,
        "./Provider/DateProvider": 24,
        "./Provider/StringProvider": 25
    }],
