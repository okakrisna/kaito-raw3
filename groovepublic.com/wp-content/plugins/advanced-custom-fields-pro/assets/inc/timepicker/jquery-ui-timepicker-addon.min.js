    ...
    if ($.ui.timepicker = $.ui.timepicker || {}, !$.ui.timepicker.version) {
        ...
        $.extend(Timepicker.prototype, {
                        ...
                        if (s = this.units[u], n = s.substr(0, 1).toUpperCase() + s.substr(1), a = null !== t["show" + n] ? t["show" + n] : this.support[s], r[s] = parseInt(t[s + "Max"] - (t[s + "Max"] - t[s + "Min"]) % t["step" + n], 10), l[s] = 0, d += '<dt class="ui_tpicker_' + s + "_label" + (a ? "" : m) + '">' + t[s + "Text"] + '</dt><dd class="ui_tpicker_' + s + (a ? "" : m) + '"><div class="ui_tpicker_' + s + "_slider" + (a ? "" : m) + '"></div>', a && t[s + "Grid"] > 0) {
                            if (d += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>', "hour" === s)
                                for (var p = t[s + "Min"]; p <= r[s]; p += parseInt(t[s + "Grid"], 10)) {
                                    ...
                                    for (var f = t[s + "Min"]; f <= r[s]; f += parseInt(t[s + "Grid"], 10)) l[s]++, d += '<td data-for="' + s + '">' + (f < 10 ? "0" : "") + f + "</td>";
                            d += "</tr></table></div>"
                        }
                        d += "</dd>"
                    }
            ...
            _onTimeChange: function() {
                if (this._defaults.showTimepicker) {
                    ...
                    var u = r[e < 12 ? "amNames" : "pmNames"][0],
                        c = e !== parseInt(this.hour, 10) || t !== parseInt(this.minute, 10) || i !== parseInt(this.second, 10) || s !== parseInt(this.millisec, 10) || n !== parseInt(this.microsec, 10) || this.ampm.length > 0 && e < 12 != ($.inArray(this.ampm.toUpperCase(), this.amNames) !== -1) || null !== this.timezone && a !== this.timezone.toString();
                    c && (e !== !1 && (this.hour = e), t !== !1 && (this.minute = t), i !== !1 && (this.second = i), s !== !1 && (this.millisec = s), n !== !1 && (this.microsec = n), a !== !1 && (this.timezone = a), this.inst || (this.inst = $.datepicker._getInst(this.$input[0])), this._limitMinMaxDateTime(this.inst, !0)), this.support.ampm && (this.ampm = u), this.formattedTime = $.datepicker.formatTime(r.timeFormat, this, r), this.$timeObj && (l === r.timeFormat ? this.$timeObj.val(this.formattedTime + o) : this.$timeObj.val($.datepicker.formatTime(l, this, r) + o)), this.timeDefined = !0, c && this._updateDateTime()
                }
            },
                ...
                slider: {
                    ...
                    options: function(e, t, i, s, n) {
                        if (e._defaults.isRTL) {
                            if ("string" == typeof s) return "min" === s || "max" === s ? void 0 !== n ? t.slider(s, n * -1) : Math.abs(t.slider(s)) : t.slider(s);
                            var a = s.min,
                                r = s.max;
                            return s.min = s.max = null, void 0 !== a && (s.max = a * -1), void 0 !== r && (s.min = r * -1), t.slider(s)
                        }
                        return "string" == typeof s && void 0 !== n ? t.slider(s, n) : t.slider(s)
                    },
                    value: function(e, t, i, s) {
                        return e._defaults.isRTL ? void 0 !== s ? t.slider("value", s * -1) : Math.abs(t.slider("value")) : void 0 !== s ? t.slider("value", s) : t.slider("value")
                    }
                },
                select: {
                    create: function(e, t, i, s, n, a, r) {
                        for (var l = '<select class="ui-timepicker-select ui-state-default ui-corner-all" data-unit="' + i + '" data-min="' + n + '" data-max="' + a + '" data-step="' + r + '">', o = e._defaults.pickerTimeFormat || e._defaults.timeFormat, u = n; u <= a; u += r) l += '<option value="' + u + '"' + (u === s ? " selected" : "") + ">", l += "hour" === i ? $.datepicker.formatTime($.trim(o.replace(/[^ht ]/gi, "")), {
                            hour: u
                ...
                a = function(e, t, i) {
                    var s = function(e, t) {
                        ...
                        n = function(e) {
                            ...
                            if (t)
                                for (var s = 0; s < t.length; s++) i[t[s].toString().charAt(0)] === -1 && (i[t[s].toString().charAt(0)] = s + 1);
                            return i
                        },
                        a = "^" + e.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(e) {
                            var t = e.length;
                    ...
                    return !!o && (r.t !== -1 && (void 0 === o[r.t] || 0 === o[r.t].length ? (l = "", u.ampm = "") : (l = $.inArray(o[r.t].toUpperCase(), $.map(i.amNames, function(e, t) {
                        return e.toUpperCase()
                    })) !== -1 ? "AM" : "PM", u.ampm = i["AM" === l ? "amNames" : "pmNames"][0])), r.h !== -1 && ("AM" === l && "12" === o[r.h] ? u.hour = 0 : "PM" === l && "12" !== o[r.h] ? u.hour = parseInt(o[r.h], 10) + 12 : u.hour = Number(o[r.h])), r.m !== -1 && (u.minute = Number(o[r.m])), r.s !== -1 && (u.second = Number(o[r.s])), r.l !== -1 && (u.millisec = Number(o[r.l])), r.c !== -1 && (u.microsec = Number(o[r.c])), r.z !== -1 && void 0 !== o[r.z] && (u.timezone = $.timepicker.timezoneOffsetNumber(o[r.z])), u)
                },
                r = function(e, t, i) {
                    try {
            ...
            var i = this._getInst($(e)[0]),
                ...
                n;
            s && i.settings.showTimepicker ? (s._limitMinMaxDateTime(i, !0), n = i.inline, i.inline = i.stay_open = !0, this._base_selectDate(e, t), i.inline = n, i.stay_open = !1, this._notifyChange(i), this._updateDatepicker(i)) : this._base_selectDate(e, t)
            ...
            if (t) {
                ...
                if (i) {
                    ...
                    r += $.datepicker.formatTime(u, t, t._defaults) + o, t._defaults.timeOnly || t._defaults.altFieldTimeOnly || null === n || (r = t._defaults.altFormat ? $.datepicker.formatDate(t._defaults.altFormat, n, a) + l + r : t.formattedDate + l + r), $(i).val(e.input.val() ? r : "")
                }
        ...
        $.timepicker = new Timepicker, $.timepicker.timezoneOffsetString = function(e, t) {
            ...
            function n(n, a) {
                ...
                if (null !== r) {
                    ...
                    u.setMilliseconds(u.getMilliseconds() + s.minInterval), c.setMilliseconds(c.getMilliseconds() + s.maxInterval), s.minInterval > 0 && u > l ? i[e]("setDate", u) : s.maxInterval > 0 && c < l ? i[e]("setDate", c) : r > l && a[e]("setDate", o)
                }
            }
